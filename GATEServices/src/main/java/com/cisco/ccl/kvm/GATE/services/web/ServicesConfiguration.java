...
@Configuration
@ComponentScan(basePackages = { "com.cisco.ccl.b2b.web.utils.diagnostics", "com.cisco.ccl.kvm.GATE.services.web.diagnostics" })
...
public class ServicesConfiguration implements AsyncConfigurer {
	...
	public AsyncTaskExecutor getAsyncExecutor() {
		...
		try {
			...
			executor.setThreadNamePrefix("GateExecutor-");
			executor.initialize();
