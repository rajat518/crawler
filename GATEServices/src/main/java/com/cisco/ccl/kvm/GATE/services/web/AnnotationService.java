...
//public static void main(String[])
	...
	public WebAsyncTask<ResponseEntity<Topics>> webCrawler(@RequestBody final Map<String, Object> bodyContent) throws IOException, GateException {
			//, -
			...
			public ResponseEntity<Topics> call() throws Exception {
	        	...
	        	if(value.equals("crawler")){
					...
					crawler.setOutputCorpus(corpus);
							...
							termFunction(corpus,path,resultspath,froot,rootUrl,querypath);
							corpus.clear();
			       ...
			       docList.add(d);
					...
					termFunction(corpus,path,resultspath,froot,pdfFile,querypath);
				}
	...
	//Corpus corpus,String path,String resultspath,String froot,String rootUrl,String querypath,
	public void termFunction(Corpus corpus,String path,String resultspath,String froot,String rootUrl,String querypath) throws Exception{
		System.out.println("Url/file that is in term raider is "+rootUrl);
